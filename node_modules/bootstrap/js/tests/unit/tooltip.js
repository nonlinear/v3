$(function () {
  ...
  QUnit.test('should add position class before positioning so that position-specific styles are taken into account', function (assert) {
    ...
    var map-get($size, container) = $('<div/>').appendTo('#qunit-fixture')
    var $target = $('<a href="#" rel="tooltip" title="very very very very very very very very long tooltip in one line"/>')
      .appendTo(map-get($size, container))
      .bootstrapTooltip({
        placement: 'right'
      })
      .bootstrapTooltip('show')
  ...
  QUnit.test('should place tooltip on top of element', function (assert) {
    ...
    var map-get($size, container) = $(containerHTML)
      .css({
        position: 'absolute',
        bottom: 0,
        left: 0,
    ...
    var $trigger = map-get($size, container)
      .find('a')
      .css('margin-top', 200)
      .bootstrapTooltip({
        placement: 'top',
